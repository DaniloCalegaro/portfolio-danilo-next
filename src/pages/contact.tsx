...
export default function Contact() {
  ...
  const handleCreateNewMessageContact: SubmitHandler<CreatMessageContact> = (
    values,
  ) => {
    //console.log(values)
  ...
  return (
    <>
      <SEO
        title="Contato - Desenvolvedor Full Stack"
        description="Entre em contato comigo para discutir seu projeto de desenvolvimento. Especializado em React, React Native, .NET Core e SQL Server."
        canonical="https://danilocalegaro.dev.br/contact"
        keywords={[
      ...
      <ContainerContact>
        ...
        <strong className="title">
          Tem um projeto de desenvolvimento? Mande-me uma mensagem se você
          quiser trabalhar juntos em algo emocionante. Grande ou pequeno
        </strong>
